...
class StorePatientRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'caregivers.*.name.required' => 'Caregiver Name is required.',
            'caregivers.*.name.regex' => 'Caregiver Name must contain only letters and spaces.',
            'caregivers.*.relation.required' => 'Relationship is required.',
            'caregivers.*.relation.regex' => 'Relationship must contain only letters and spaces.',
            'caregivers.*.contact_no.required' => 'Contact Number is required.',
