                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="sct_no" class="form-control" value="{{ old('sct_no', $patient->sct_no) }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="diagnosis" class="form-control" rows="3">{{ old('diagnosis', $patient->diagnosis) }}</textarea>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="route_map" class="form-control" rows="2">{{ old('route_map', $patient->route_map) }}</textarea>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="hospital_department" class="form-control" value="{{ old('hospital_department', $patient->hospital_department) }}">
                            </div>
                        </div>
                    </div>
                </div>
